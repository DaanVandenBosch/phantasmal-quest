...
import { parse_nj_model } from './nj';
import type { NjContext } from './nj';
import { parse_xj_model } from './xj';
import type { XjContext } from './xj';
...
function parse_ninja(cursor: ArrayBufferCursor, format: Format): ?Object3D {
...
function parse_njcm(cursor: ArrayBufferCursor, format: Format): ?BufferGeometry {
