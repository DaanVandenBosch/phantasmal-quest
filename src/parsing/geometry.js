...
export function parse_c_rel(array_buffer: ArrayBuffer): Object3D {
    ...
    for (
        ...
        const triangle_index_offset = geometry.vertices.length;
        ...
        for (
            ...
            if (geometry_offset > 0) {
                ...
                for (
                    ...
                    const rotated_x = cos_section_rotation * x + sin_section_rotation * z;
                    const rotated_z = -sin_section_rotation * x + cos_section_rotation * z;
